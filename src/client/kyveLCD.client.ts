...
import {
    QueryAccountAssetsRequest, QueryAccountAssetsResponse,
    QueryAccountDelegationListRequest, QueryAccountDelegationListResponse,
    QueryAccountFundedListRequest,
    QueryAccountFundedListResponse,
    QueryAccountStakedListRequest,
    QueryAccountStakedListResponse,
    QueryCanProposeRequest, QueryCanProposeResponse,
    QueryCanVoteRequest,
    QueryCanVoteResponse, QueryDelegatorRequest, QueryDelegatorResponse, QueryDelegatorsByPoolAndStakerRequest,
    ...
    QueryStakeInfoRequest, QueryStakeInfoResponse, QueryStakerRequest,
    QueryStakerResponse,
    QueryStakersByPoolAndDelegatorRequest, QueryStakersByPoolAndDelegatorResponse, QueryStakersListRequest,
...
export default function createLCDClient(restEndpoint: string) {
    const lcdClient = LcdClient.withExtensions({apiUrl: restEndpoint},
    setupAuthExtension,
    setupBankExtension,
    setupDistributionExtension,
    setupGovExtension,
    ...
    setupSlashingExtension,
    setupStakingExtension,
    setupSupplyExtension) as LCDClientType & { kyve: KyveLCDClient }
...
export class KyveLCDClient {
    ...
    constructor(restEndpoint: string) {
        ...
        this.request = (url: string, params?: Record<string, any>) =>
            axios.get(new URL(url, this.restEndpoint).href, {params}).then(res => res.data)
    }
    ...
    async fundersList(params: QueryFundersListRequest): Promise<QueryFundersListResponse> {
        const parameters: Record<string, any> = {};
    ...
    async stakersList(params: QueryStakersListRequest): Promise<QueryStakersListResponse> {
    ...
    /* Proposals ... */
    async proposals(params: WithOptional<QueryProposalsRequest, 'pagination'>): Promise<QueryProposalsResponse> {
        const parameters: Record<string, any> = {};
        ...
        return await this.request(endpoint).catch(e => console.log('e------->', e));
    }

    /* ProposalByHeight ... */
    async proposalByHeight(params: QueryProposalByHeightRequest): Promise<QueryProposalByHeightResponse> {
        const endpoint = `kyve/registry/v1beta1/proposal_by_height/${params.poolId}/${params.height}`;
        return await this.request(endpoint);
    }

    /* CanPropose ... */
    async canPropose(params: QueryCanProposeRequest): Promise<QueryCanProposeResponse> {
    ...
    async stakeInfo(params: QueryStakeInfoRequest): Promise<QueryStakeInfoResponse> {
    ...
    async accountAssets(params: QueryAccountAssetsRequest): Promise<QueryAccountAssetsResponse> {
    ...
    async accountFundedList(params: QueryAccountFundedListRequest): Promise<QueryAccountFundedListResponse>{
        const endpoint = `kyve/registry/v1beta1/account_funded_list/${params.address}`;
        return await this.request(endpoint);
    }
    /* AccountStakedList ... */
    async accountStakedList(params: QueryAccountStakedListRequest): Promise<QueryAccountStakedListResponse> {
        const endpoint = `kyve/registry/v1beta1/account_staked_list/${params.address}`;
        return await this.request(endpoint);
    }

    /* AccountDelegationList ... */
    async accountDelegationList(params: QueryAccountDelegationListRequest): Promise<QueryAccountDelegationListResponse> {
        const parameters: Record<string, any> = {};
    ...
    async delegator(params: QueryDelegatorRequest): Promise<QueryDelegatorResponse> {
        const endpoint = `kyve/registry/v1beta1/delegator/${params.poolId}/${params.staker}/${params.delegator}`;
        return await this.request(endpoint);
    }

    /* DelegatorsByPoolAndStaker ... */
    async delegatorsByPoolAndStaker(params: QueryDelegatorsByPoolAndStakerRequest): Promise<QueryDelegatorsByPoolAndStakerResponse> {
        const parameters: Record<string, any> = {};
    ...
    async stakersByPoolAndDelegator(params: QueryStakersByPoolAndDelegatorRequest): Promise<QueryStakersByPoolAndDelegatorResponse> {
        const parameters: Record<string, any> = {};
