...
export declare class KyveSDK {
    ...
    govSubmitProposal(type: "TextProposal" | "ParameterChangeProposal" | "CreatePoolProposal" | "UpdatePoolProposal" | "PausePoolProposal" | "UnpausePoolProposal" | "SchedulePoolUpgradeProposal" | "CancelPoolUpgradeProposal", content: Object, amount: BigNumber, isExpedited?: boolean): Promise<{
        transactionHash: string;
        transactionBroadcast: Promise<DeliverTxResponse>;
    }>;
